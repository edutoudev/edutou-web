            ...
            {currentView !== "forgot" && (
              <>
                ...
                <Button
                  ...
                  className="w-full h-12 bg-white dark:bg-slate-800 reading:bg-amber-50 border-gray-300 dark:border-slate-600 reading:border-amber-300 hover:bg-orange-50 dark:hover:bg-slate-700 reading:hover:bg-amber-100 text-gray-900 dark:text-gray-100 reading:text-amber-900 rounded-xl shadow-sm hover:shadow transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {!googleLoading && (
