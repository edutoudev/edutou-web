              ...
              <>
                <div className="relative">
                  <div className="absolute inset-0 flex items-center">
                    <span className="w-full border-t border-gray-300 dark:border-slate-600 reading:border-amber-300" />
                  </div>
                ...
                <Button
                  ...
                  disabled={loading}
                  variant="outline"
                  className="w-full h-12 text-sm font-semibold border-2 border-gray-300 dark:border-slate-600 reading:border-amber-300 hover:border-orange-500 dark:hover:border-orange-600 reading:hover:border-orange-600 bg-white dark:bg-slate-800 reading:bg-amber-50 text-gray-900 dark:text-gray-100 reading:text-amber-900 rounded-xl shadow hover:shadow-lg transition-all disabled:opacity-50"
                >
